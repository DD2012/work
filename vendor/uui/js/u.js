...
var execIgnoreError$1 = function(a, b, c) {
	try {
		a.call(b, c);
	} catch(e) {}
};
...
u$2.event.swipe = {
    ...
    handleSwipe: function(start, stop, thisObject, origTarget) {
        if (stop.time - start.time < u$2.event.swipe.durationThreshold &&
            Math.abs(start.coords[0] - stop.coords[0]) > u$2.event.swipe.horizontalDistanceThreshold &&
            Math.abs(start.coords[1] - stop.coords[1]) < u$2.event.swipe.verticalDistanceThreshold) {
 ...
 * element
 */
var makeModal$1 = function(element, parEle) {
...
var dateToUTCString = function(date$$1) {
	if(!date$$1) return ''
	if(date$$1.indexOf("-") > -1)
    ...
    for(var i = 0; i < comps.length; i++){
        if (comps[i].doValidate){
            ...
            if(passed && !result.passed){
                ...
                if(env$1.isIPAD){ // ipad上面云表单提交校验的时候没有滚动到对应位置
...
Refer.fn.create = function () {
    ...
    if (!this.options.isPOPMode) {
        ...
        if (dialog$$1 == null) {
            ...
            dialog$$1 = makeDOM('	<div style="display:none;height:100%" id="' + prefixID + '">' +
...
DateTimePicker$1.fn._carousel = function(newPage, direction) {
    ...
    if (env$1.isIE8 || env$1.isIE9 || env$1.isFF || true) { // 动画存在问题，禁用动画
...
DateTimePicker$1.fn._fillTime = function(type) {
    ...
    // }
    if (env$1.isIE8) { // IE8/IE9保持原来，非IE8/IE9使用clockpicker
 ...
 */
const setEnable$1 = function(enable) {
 ...
 */
const on$2 = function(name, callback, one) {
    var self = this,
        origCb = callback;
 ...
 */
const off$2 = function(name, callback) {
    name = name.toLowerCase();
    if (!this._events)
        return this;
    if (Object.prototype.toString.call(name) == '[object Array]') {
 ...
 */
const getRowByRowId$1 = function(rowid) {
 ...
 */
const getRowMeta$1 = function(rowIndex, fieldName, metaName) {
    var row = this.rows[rowIndex];
    if (row) {
 ...
 */
const removeRowByRowId$1 = function(rowid) {
    for (var i = 0, count = this.rows.length; i < count; i++) {
        if (this.rows[i].rowId == rowid) {
            this.rows.splice(i, 1);
            count--;
...
// 新增/删除行之后更新选中行的index
const updateSelectedIndices$1 = function(index, type, num) {
    if (!isNumber$1(num)) {
        num = 1;
    }
    var selectedIndices = this.selectedIndices.slice();
...
//新增/删除行之后更新焦点行
const updateFocusIndex$1 = function(opIndex, opType, num) {
    if (!isNumber$1(num)) {
        num = 1;
    }
...
const PageProto = Page$1.prototype;
 ...
 */
const setValue$1 = function(fieldName, value, ctx, options) {
 ...
 */
const setData$1 = function(data, subscribe, options) {
...
// 效果同setData
const updateRow$1 = function(row) {
    this.setData(row);
};
 ...
 * row.getValue('field1')
 */
const getValue$1 = function(fieldName) {
 ...
 */
const getMeta$1 = function(fieldName, key, fetchParent) {
    if (arguments.length == 0) {
        var mt = {};
 ...
 */
const getSimpleData$1 = function(options) {
    options = options || {};
 ...
 */
const setMeta$1 = function(fieldName, key, value) {
    var meta = rowUtilFunObj._getField(this, fieldName).meta;
    if (!meta)
 ...
 */
const ref$1 = function(fieldName) {
 ...
 */
const refMeta$1 = function(fieldName, key) {
    if (!this.metaChange[fieldName + '.' + key])
        this.metaChange[fieldName + '.' + key] = ko.observable(1);
    return ko.pureComputed({
        read: function() {
 ...
 */
const setSimpleData$1 = function(data, status) {
    var allData = {};
    allData.data = data;
...
class Row$1 extends Events {
    constructor(options) {
         ...
         * @type {string}
         */
        this.rowId = options['id'] || Row$1.getRandomRowId();
        /**
         * 当前行的状态
...
const RowProto = Row$1.prototype;
...
var TimeAdapter = u.BaseAdapter.extend({
    init: function(options) {
        ...
        if (this.options.type == 'u-clockpicker' && !env$1.isIE8)
 ...
 */
const addDataTable$1 = function(dataTableId, rule) {
...
const _successFunc$1 = function (data, deferred) {
    if (typeof data === 'string')
        data = JSON.parse(data);
...
const setCompression = function (compression) {
    if (!env$1.isIE8 && !window.pako && compression == true)
