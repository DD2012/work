define(['text!pages/productionMethodConfirm/productionMethodConfirm.html', 'css!pages/productionMethodConfirm/productionMethodConfirm', 'uui', 'uuigrid', 'bootstrap', 'uuitree'], function (html) {
                ...
                pageInit: function () {
                    $.ajax({
                        ...
                        if (res.result == 1) {
                            ...
                            viewModel.pbillName = res.data.pbillName;
