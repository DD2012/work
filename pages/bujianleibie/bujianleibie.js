define(['text!pages/bujianleibie/bujianleibie.html', 'css!pages/bujianleibie/bujianleibie', 'uui', 'uuigrid', 'bootstrap', 'uuitree'], function (html) {
    var init = function (element) {
        ...
        viewModel.logisticsMethod.setSimpleData([
            {code: 'QY0000000000000111', name: '沙发', canEdit: false},
            {code: 'QY0000000000000112', name: '实木', canEdit: false},
            {code: 'QY0000000000000113', name: '坐椅', canEdit: false}
        ]);
        viewModel.logisticsMethod.setAllRowsUnSelect();
