define(['text!pages/productionConfirm/productionConfirm.html', 'css!pages/productionConfirm/productionConfirm', 'uui', 'uuigrid', 'bootstrap', 'uuitree'], function (html) {
                ...
                pageInit: function () {
                    $.ajax({
                        ...
                        if (res.result == 1) {
                            ...
                            viewModel.factory = res.data.factory;
